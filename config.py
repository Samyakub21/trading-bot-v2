...
class Config:
    ...
    def __init__(self):
        ...
        self.TELEGRAM_TOKEN = str(self.TELEGRAM_TOKEN).strip() if self.TELEGRAM_TOKEN else ""
        self.TELEGRAM_CHAT_ID = str(self.TELEGRAM_CHAT_ID).strip() if self.TELEGRAM_CHAT_ID else ""
    ...
    # --- Properties ---
    @property
    def MAX_DAILY_LOSS(self) -> float: return self._trading_config["MAX_DAILY_LOSS"]
    @property
    def MAX_TRADES_PER_DAY(self) -> int: return self._trading_config["MAX_TRADES_PER_DAY"]
    @property
    def COOLDOWN_AFTER_LOSS(self) -> int: return self._trading_config["COOLDOWN_AFTER_LOSS"]
    @property
    def SIGNAL_COOLDOWN(self) -> int: return self._trading_config["SIGNAL_COOLDOWN"]
    @property
    def AUTO_SQUARE_OFF_BUFFER(self) -> int: return self._trading_config["AUTO_SQUARE_OFF_BUFFER"]
    @property
    def RSI_BULLISH_THRESHOLD(self) -> float: return self._trading_config["RSI_BULLISH_THRESHOLD"]
    @property
    def RSI_BEARISH_THRESHOLD(self) -> float: return self._trading_config["RSI_BEARISH_THRESHOLD"]
    @property
    def VOLUME_MULTIPLIER(self) -> float: return self._trading_config["VOLUME_MULTIPLIER"]
    @property
    def LIMIT_ORDER_BUFFER(self) -> float: return self._trading_config["LIMIT_ORDER_BUFFER"]
    @property
    def STATE_FILE(self) -> str: return self._trading_config["STATE_FILE"]
    @property
    def DAILY_PNL_FILE(self) -> str: return self._trading_config["DAILY_PNL_FILE"]
    @property
    def TRADE_HISTORY_FILE(self) -> str: return self._trading_config["TRADE_HISTORY_FILE"]
    @property
    def USE_DATABASE(self) -> bool: return self._trading_config.get("USE_DATABASE", True)
    @property
    def DATABASE_PATH(self) -> str: return self._trading_config.get("DATABASE_PATH", str(DATA_DIR / "trading_bot.db"))
    @property
    def POLL_FALLBACK_ENABLED(self) -> bool: return self._trading_config.get("POLL_FALLBACK_ENABLED", True)
    @property
    def POLL_FALLBACK_THRESHOLD(self) -> int: return self._trading_config.get("POLL_FALLBACK_THRESHOLD", 5)
    @property
    def POLL_COOLDOWN(self) -> int: return self._trading_config.get("POLL_COOLDOWN", 2)
    @property
    def ENABLED_INSTRUMENTS(self) -> list: return self._trading_config.get("ENABLED_INSTRUMENTS", ["CRUDEOIL", "NATURALGAS", "GOLD", "SILVER", "NIFTY", "BANKNIFTY"])
    @property
    def INSTRUMENT_PRIORITY(self) -> dict: return self._trading_config.get("INSTRUMENT_PRIORITY", {"CRUDEOIL": 1, "GOLD": 2, "SILVER": 3, "NATURALGAS": 4, "NIFTY": 5, "BANKNIFTY": 6})
    @property
    def PER_INSTRUMENT_SETTINGS(self) -> dict: return self._trading_config.get("PER_INSTRUMENT_SETTINGS", {})
    ...
    @property
    def HEARTBEAT_TIMEOUT_SECONDS(self) -> int: return 30
    @property
    def RECONNECT_DELAY_SECONDS(self) -> int: return 5
    @property
    def MIN_TICK_INTERVAL_MS(self) -> int: return 100
