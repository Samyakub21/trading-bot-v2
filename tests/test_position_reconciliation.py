...
class TestReconcilePositions:
    ...
    def test_reconcile_matched_with_position(
        self, 
        mock_fetch, 
        active_trade_with_position, 
        mock_instruments
    ):
        """Should return MATCHED when local and broker positions match"""
        from position_reconciliation import reconcile_positions, ReconciliationStatus, BrokerPosition
    ...
    @patch('position_reconciliation.fetch_broker_positions')
    def test_reconcile_error_on_fetch_failure(self, mock_fetch, active_trade_with_position):
...
class TestAutoFixMismatch:
    ...
    def test_auto_fix_local_only_clears_state(
        ...
        from position_reconciliation import (
            auto_fix_mismatch, ReconciliationResult, ReconciliationStatus
        )
    ...
    def test_auto_fix_quantity_mismatch_updates_local(
        ...
        from position_reconciliation import (
            auto_fix_mismatch, ReconciliationResult, ReconciliationStatus, BrokerPosition
        )
...
class TestStartupReconciliation:
    ...
    def test_startup_reconcile_pass(self, mock_reconcile, active_trade_with_position):
        ...
        from position_reconciliation import (
            reconcile_on_startup, ReconciliationResult, ReconciliationStatus
        )
