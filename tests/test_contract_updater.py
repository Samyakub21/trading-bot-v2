    ...
    return [
        {
            ...
            "SEM_TRADING_SYMBOL": "CRUDEOIL-26JAN-FUT",
            "SEM_CUSTOM_SYMBOL": "CRUDEOIL JAN FUT",
        ...
        },
        {
            ...
            "SEM_EXM_EXCH_ID": "MCX",
            "SEM_INSTRUMENT_NAME": "FUTCOM",
            "SEM_TRADING_SYMBOL": "CRUDEOIL-25DEC-FUT",  # Expired
            "SEM_CUSTOM_SYMBOL": "CRUDEOIL DEC FUT",
        ...
        },
        {
            ...
            "SEM_EXM_EXCH_ID": "MCX",
            "SEM_INSTRUMENT_NAME": "FUTCOM",
            "SEM_TRADING_SYMBOL": "GOLD-26JAN-FUT",
            "SEM_CUSTOM_SYMBOL": "GOLD JAN FUT",
            "SEM_EXPIRY_DATE": future_expiry,
            "SEM_LOT_UNITS": "100",
        },
        {
            ...
            "SEM_TRADING_SYMBOL": "CRUDEOIL-26JAN6000CE",
            "SEM_CUSTOM_SYMBOL": "CRUDEOIL JAN FUT",
            "SEM_EXPIRY_DATE": future_expiry,
            "SEM_LOT_UNITS": "10",
...
class TestGetUpdatedInstrumentConfig:
    ...
    def test_update_config_success(
        self, mock_load, sample_contracts, sample_instrument_config
    ):
        ...
        result = get_updated_instrument_config(
            "CRUDEOIL", sample_instrument_config["CRUDEOIL"]
        )
...
class TestUpdateAllInstruments:
    ...
    def test_update_all_instruments(
        self, mock_update, mock_download, sample_instrument_config
    ):
    ...
    @patch("contract_updater.download_scrip_master")
    @patch("contract_updater.get_updated_instrument_config")
    def test_keep_original_on_failure(
        self, mock_update, mock_download, sample_instrument_config
    ):
...
class TestIsCacheValid:
    ...
    def test_cache_valid_today(self, mock_file, mock_exists):
        ...
        mock_exists.return_value = True
        today_cache = {"updated_at": datetime.now().isoformat(), "contracts": {}}
...
class TestAutoUpdateOnStartup:
    ...
    def test_fetch_when_no_cache(
        self, mock_save, mock_update, mock_load_cache, sample_instrument_config
    ):
